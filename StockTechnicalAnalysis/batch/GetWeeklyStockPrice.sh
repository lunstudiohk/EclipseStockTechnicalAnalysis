...
java -Dspring.config=file:$RESOURCES/Spring-Config.xml -Duser.timezone=Asia/Hong_Kong -Xmx128m -Dlog4j.configurationFile=$RESOURCES/log4j2.xml com.lunstudio.stocktechnicalanalysis.batch.GenerateWeeklyStockPrice
